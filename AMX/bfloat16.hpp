/* This bfloat16 implementation is influenced by the bfloat16 implementation found here
https://github.com/opendcdiag/opendcdiag/blob/main/framework/fp_vectors/Floats.h
*/
...
inline BFloat16::BFloat16(float f)
    : BFloat16(fp32_to_bf16(f))
{
}

static inline float bf16_to_fp32(BFloat16 r)
{
